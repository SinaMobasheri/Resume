...
%
% Important note:
% This template requires the summary.cls file to be in the same directory as the
% .tex file. The summary.cls file provides the resume style used for structuring the
% document.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\documentclass[10pt]{summary} % Use the summary.cls style, the font size can be changed to 11pt or 12pt here
